...
type Querier interface {
	...
	GetWebAuthnCredentialByCredentialID(ctx context.Context, credentialID pgtype.UUID) (GetWebAuthnCredentialByCredentialIDRow, error)
	GetWebAuthnCredentialByKeyID(ctx context.Context, keyID []byte) (GetWebAuthnCredentialByKeyIDRow, error)
	...
	ListWebAuthnCredentialsByAccount(ctx context.Context, arg ListWebAuthnCredentialsByAccountParams) ([]ListWebAuthnCredentialsByAccountRow, error)
	...
	UpdateWebAuthnCredentialAssertion(ctx context.Context, arg UpdateWebAuthnCredentialAssertionParams) (WebauthnCredential, error)
